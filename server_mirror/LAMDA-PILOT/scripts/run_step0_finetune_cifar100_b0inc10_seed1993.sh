...
RUN_NAME="step0_finetune_cifar100_b0inc10_seed1993"
CONFIG="exps/${RUN_NAME}.json"
OUTPUT_DIR="outputs/${RUN_NAME}"
WRAPPER_LOG="logs/${RUN_NAME}.log"
REPO_LOG="logs/finetune/cifar224/0/10/step0_1993_vit_base_patch16_224.log"
...
python scripts/extract_step0_metrics.py \
    --run-name "${RUN_NAME}" \
    --config "${CONFIG}" \
